...
class MusicAdapter(
    ...
    private val onQrClick: (Music) -> Unit
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        return ViewHolder(view, album, onPlayClicked, onQrClick)
    }
    ...
    class ViewHolder(
        ...
        private val qrButton: ImageButton = itemView.findViewById(R.id.qr_button)
        ...
        fun bindView(music: Music) {
            ...
            // Set the QR code click listener
